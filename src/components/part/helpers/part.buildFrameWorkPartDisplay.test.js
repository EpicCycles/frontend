...
test('should return sections including empty and matching parts when include empty', () => {
  const parts = [
    { id: 11, partType: 1 },
    { id: 13, partType: 3 },
    { id: 214, partType: 14 },
...
test('should return sections including empty sections and  multiples when include empty', () => {
  const parts = [
    { id: 11, partType: 1 },
    { id: 13, partType: 3 },
    { id: 214, partType: 14 },
