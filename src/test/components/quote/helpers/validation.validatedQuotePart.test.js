...
describe('validatedQuotePart', () => {
  ...
  describe('for a non bike quote', () => {
    it('should expect a part when a part type is selected', () => {
      ...
      expect(quotePartValidation(startPart, undefined, undefined, brands, parts, {})).toEqual(
        validatedPart,
      );
    });
  });
  describe('for a bike quote', () => {
    ...
    it('should return no errors when all fields are OK', () => {
      ...
      expect(
        quotePartValidation(startPart, undefined, normalPartType, brands, parts, quote),
      ).toEqual(validatedPart);
    });
  ...
  describe('for a non bike club member', () => {
