...
import {moveObjectDownOnePlace} from '../../../../components/framework/helpers/framework';

describe('moveObjectDownOnePlace tests', () => {
    it('does not fail if an id is not found', () => {
        const sections = [
            {id: 97, placing: 2},
            {id: 7, placing: 3},
        ];
        const newSections = moveObjectDownOnePlace(sections, 33);
